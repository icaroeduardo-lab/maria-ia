# Fase 1 — RDS PostgreSQL na VPC nova (o v2 é dono da sua camada de dados).
# "RDS mantido" = mesma tecnologia (Postgres/RDS); a migração dos dados da
# instância provisória de teste é um passo à parte (dump/restore).
